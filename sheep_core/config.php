...
define('SHEEP_URL', 'localhost/mkt2/');//ou dominio exemplo: maykonsilveira.com.br
define('SHEEP_HOST','localhost');
define('SHEEP_USER','root');
define('SHEEP_SENHA','');
define('SHEEP_BD','mtk2');
...
define('EMAIL_PHPMAILER_HOST', 'smtp-relay.sendinblue.com');
define('EMAIL_PHPMAILER_USERNAME', 'maykonsilveirayyy777@gmail.com');
define('EMAIL_PHPMAILER_PASS', 'jG1tJCBHaL28EKVQ');
define('EMAIL_PHPMAILER_PORT', "587");
define('EMAIL_PHPMAILER_QUEM_ENVIA', "cursos@maykonsilveira.com.br");
